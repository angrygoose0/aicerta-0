...
from .utils import encode_image, encode_image_from_url, encoded_image
...
class MathPix(object):
    ...
    def process_image(
            self, image_path=None, image_url=None, image=None, region=None,
